...
const PRODUCTOS = [
  { icon: PiggyBank, color: '#e2132b', titulo: 'Cuenta de Ahorros', desc: 'Maneja tu dinero sin costo de mantenimiento y gana intereses todos los días con Surgir.' },
  ...
  return (
    <div className="lp-page">
      ...
      <section className="lp-hero">
        <div className="lp-hero-inner">
          <div className="lp-hero-text">
            <span className="lp-hero-tag">Banca Digital · Financiera Surgir</span>
            <h1>Tu financiera digital, <br />inspirada en el Perú emprendedor</h1>
            <p>
              Abre tu cuenta, paga tus créditos y transfiere tu dinero en minutos.
              Todo desde tu Banca por Internet de Surgir, con la seguridad que mereces.
            </p>
      ...
      <section className="lp-section" id="beneficios">
        <div className="lp-section-head">
          <h2>¿Por qué Financiera Surgir?</h2>
          <p>Una financiera cercana, segura y hecha para el Perú emprendedor.</p>
        </div>
