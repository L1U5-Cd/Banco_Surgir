# Financiera Surgir — Banca por Internet (Homebanking)

Portal del **cliente final** de Financiera Surgir, construido en **React 18 + Vite (JavaScript)**.
Consume el backend FastAPI del Homebanking que corre en `http://localhost:8002`.

> Identidad visual de **Financiera Surgir**: isotipo de marca, paleta corporativa moderna en tonos rojos,
> turquesa y acentos cálidos, con franja de identidad superior, header limpio y tarjetas redondeadas.
...
1. **Login** — tarjeta centrada con logo de Financiera Surgir sobre un fondo de marca y franja de identidad.
